...
public class GetAllCoinTest extends CommonTest {
    ...
    public void coinGetAllOk(){
        ...
        ResponseEntity<CoinGetAllResponse> response = restTemplate.exchange(URL, HttpMethod.GET, getAdmin(), CoinGetAllResponse.class);
